<?php
//formulario similar a add-items.php pero con la lógica de formulario cambiada para actualizar en vez de crear nuevas entradas.
...
<form action="actions/update_item.php" method="POST" class="add-item-form">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <a href="index.php?var=user_profile&view=manage_items">&laquo; Volver</a>
    </div>
